...
export class DatabaseService implements OnModuleInit, OnModuleDestroy {
  ...
  private async initializePostgresSchema() {
    ...
    const migrationStatements = [
      ...
      `ALTER TABLE IF EXISTS products ADD COLUMN IF NOT EXISTS variant VARCHAR(100);`,
      `ALTER TABLE IF EXISTS products ADD COLUMN IF NOT EXISTS packaging VARCHAR(100);`,
      `ALTER TABLE IF EXISTS sales DROP CONSTRAINT IF EXISTS sales_cashier_id_fkey;`,
      `ALTER TABLE IF EXISTS sales DROP CONSTRAINT IF EXISTS sales_store_id_fkey;`,
      `ALTER TABLE IF EXISTS expenses DROP CONSTRAINT IF EXISTS expenses_branch_id_fkey;`,
      `ALTER TABLE IF EXISTS expenses DROP CONSTRAINT IF EXISTS expenses_store_id_fkey;`,
      `ALTER TABLE IF EXISTS expenses ALTER COLUMN branch_id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS expenses ALTER COLUMN branch_id SET DATA TYPE TEXT USING branch_id::TEXT;`,
      `ALTER TABLE IF EXISTS expenses ALTER COLUMN store_id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS expenses ALTER COLUMN store_id SET DATA TYPE TEXT USING store_id::TEXT;`,
      `ALTER TABLE IF EXISTS expenses ALTER COLUMN approved_by DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS expenses ALTER COLUMN approved_by SET DATA TYPE TEXT USING approved_by::TEXT;`,
      `ALTER TABLE IF EXISTS debts ALTER COLUMN approved_by DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS debts ALTER COLUMN approved_by SET DATA TYPE TEXT USING approved_by::TEXT;`,
      `ALTER TABLE IF EXISTS debts ALTER COLUMN debtor_worker_id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS debts ALTER COLUMN debtor_worker_id SET DATA TYPE TEXT USING debtor_worker_id::TEXT;`,
      `ALTER TABLE IF EXISTS stock_ledger ALTER COLUMN reference_id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS stock_ledger ALTER COLUMN reference_id SET DATA TYPE TEXT USING reference_id::TEXT;`,
      `ALTER TABLE IF EXISTS stock_ledger ALTER COLUMN created_by DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS stock_ledger ALTER COLUMN created_by SET DATA TYPE TEXT USING created_by::TEXT;`,
      `ALTER TABLE IF EXISTS stock_ledger ALTER COLUMN device_id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS stock_ledger ALTER COLUMN device_id SET DATA TYPE TEXT USING device_id::TEXT;`,
      `ALTER TABLE IF EXISTS stock_ledger DROP CONSTRAINT IF EXISTS stock_ledger_created_by_fkey;`,
      `ALTER TABLE IF EXISTS stock_ledger DROP CONSTRAINT IF EXISTS stock_ledger_store_id_fkey;`,
      `ALTER TABLE IF EXISTS stock_ledger DROP CONSTRAINT IF EXISTS stock_ledger_product_id_fkey;`,
      `ALTER TABLE IF EXISTS salaries ALTER COLUMN worker_id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS salaries ALTER COLUMN worker_id SET DATA TYPE TEXT USING worker_id::TEXT;`,
      `ALTER TABLE IF EXISTS salaries ALTER COLUMN paid_by DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS salaries ALTER COLUMN paid_by SET DATA TYPE TEXT USING paid_by::TEXT;`,
      ...
      `ALTER TABLE IF EXISTS audit_logs ALTER COLUMN user_id SET DATA TYPE TEXT USING user_id::TEXT;`,
      `ALTER TABLE IF EXISTS audit_logs ALTER COLUMN entity_id SET DATA TYPE TEXT USING entity_id::TEXT;`,
      `ALTER TABLE IF EXISTS field_sessions DROP CONSTRAINT IF EXISTS field_sessions_store_id_fkey;`,
      `ALTER TABLE IF EXISTS field_sessions DROP CONSTRAINT IF EXISTS field_sessions_vehicle_id_fkey;`,
      `ALTER TABLE IF EXISTS field_sessions DROP CONSTRAINT IF EXISTS field_sessions_worker_id_fkey;`,
      `ALTER TABLE IF EXISTS field_sessions DROP CONSTRAINT IF EXISTS field_sessions_created_by_fkey;`,
      `ALTER TABLE IF EXISTS field_sessions ALTER COLUMN id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS field_sessions ALTER COLUMN id SET DATA TYPE TEXT USING id::TEXT;`,
      `ALTER TABLE IF EXISTS field_sessions ALTER COLUMN store_id SET DATA TYPE TEXT USING store_id::TEXT;`,
      `ALTER TABLE IF EXISTS field_sessions ALTER COLUMN vehicle_id SET DATA TYPE TEXT USING vehicle_id::TEXT;`,
      `ALTER TABLE IF EXISTS field_sessions ALTER COLUMN worker_id SET DATA TYPE TEXT USING worker_id::TEXT;`,
      `ALTER TABLE IF EXISTS field_sessions ALTER COLUMN created_by DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS field_sessions ALTER COLUMN created_by SET DATA TYPE TEXT USING created_by::TEXT;`,
      `ALTER TABLE IF EXISTS field_sessions ADD COLUMN IF NOT EXISTS return_store_id TEXT;`,
      `ALTER TABLE IF EXISTS field_session_items DROP CONSTRAINT IF EXISTS field_session_items_field_session_id_fkey;`,
      `ALTER TABLE IF EXISTS field_session_items DROP CONSTRAINT IF EXISTS field_session_items_product_id_fkey;`,
      `ALTER TABLE IF EXISTS field_session_items ALTER COLUMN id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS field_session_items ALTER COLUMN id SET DATA TYPE TEXT USING id::TEXT;`,
      `ALTER TABLE IF EXISTS field_session_items ALTER COLUMN field_session_id SET DATA TYPE TEXT USING field_session_id::TEXT;`,
      `ALTER TABLE IF EXISTS field_session_items ALTER COLUMN product_id SET DATA TYPE TEXT USING product_id::TEXT;`,
      `ALTER TABLE IF EXISTS field_reconciliations DROP CONSTRAINT IF EXISTS field_reconciliations_field_session_id_fkey;`,
      `ALTER TABLE IF EXISTS field_reconciliations DROP CONSTRAINT IF EXISTS field_reconciliations_reconciled_by_fkey;`,
      `ALTER TABLE IF EXISTS field_reconciliations ALTER COLUMN id DROP DEFAULT;`,
      `ALTER TABLE IF EXISTS field_reconciliations ALTER COLUMN id SET DATA TYPE TEXT USING id::TEXT;`,
      `ALTER TABLE IF EXISTS field_reconciliations ALTER COLUMN field_session_id SET DATA TYPE TEXT USING field_session_id::TEXT;`,
