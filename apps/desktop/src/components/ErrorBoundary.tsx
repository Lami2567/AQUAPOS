    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 text-slate-100 select-none">
          <div className="max-w-lg w-full bg-slate-900 border border-white/15 rounded-3xl p-6 shadow-2xl space-y-4 text-center">
            <div className="w-14 h-14 bg-white/10 border border-white/15 text-white rounded-2xl flex items-center justify-center mx-auto">
            ...
            {this.state.error && (
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 text-left font-mono text-[11px] text-white/90 max-h-40 overflow-y-auto">
